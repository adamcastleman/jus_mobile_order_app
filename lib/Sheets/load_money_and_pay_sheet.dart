...
import '../Widgets/Tiles/wallet_load_balance_tile.dart';
...
class LoadWalletAndPaySheet extends ConsumerWidget {
          ...
          return Padding(
            ...
            child: Wrap(
              children: [
                ...
                determineAddPaymentTile(context, ref, user),
                const Padding(
                  padding: EdgeInsets.only(
                    top: 22.0,
                  ),
                ...
                walletHelpers.displayOrderTotal(user),
                Padding(
  ...
  Widget _determinePaymentButton(
    ...
    if (applePayLoading || loading) {
      ...
      return WalletProviderWidget(
        builder: (wallets) => LoadWalletAndPayButton(
