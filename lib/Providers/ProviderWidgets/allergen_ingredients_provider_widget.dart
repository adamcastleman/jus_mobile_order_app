...
class AllergenIngredientsProviderWidget extends ConsumerWidget {
  final Widget Function(List<IngredientModel> ingredients) builder;
  final dynamic loading;
  final dynamic error;
  const AllergenIngredientsProviderWidget(
      {required this.builder, this.loading, this.error, super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final ingredients = ref.watch(allergenIngredientsProvider);
